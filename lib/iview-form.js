      ...
      return this.formList.map(function (item) {
        ...
        switch (item.type) {
          ...
          case 'switch':
            ...
            break;
          case 'slider':
            content = _this.renderSlider(h, item);
            break;
          default:
        ...
        return h(getPrefix('form-item', _this.lib), {
          props: {
            prop: item.key
          }
        }, [_this.renderTitle(h, item), content]);
      });
    },
      ...
      return h(tagName, {
        ...
        on: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_extends___default()({
          input: function input(value) {
            value = _this6.formatDateValue(value, item, formatValue);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_1_vue_loader_lib_selector_type_script_index_0_iview_form_vue__ = __webpack_require__(4);
