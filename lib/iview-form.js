  ...
  methods: {
    ...
    getFormItem: function getFormItem(h, item, content) {
      ...
      if (typeof item.render === 'function') {
        ...
        return h(getPrefix('form-item', this.lib), __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(settings, item.settings), [this.renderTitle(h, item), content]);
      }
    },
    ...
    generateTag: function generateTag(_ref) {
      ...
      var currProps = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({
      ...
      var attrs = item.attrs || {};
      // 设置 readonly
      var target = this.lib === 'iview' ? props : attrs;
      var readonly = this.readonly || item.readonly;
      ...
      return h(tagName, {
        ...
        on: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({
    ...
    getForm: function getForm() {
      return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_extends___default()({}, this.form);
    },
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-0f69e25b", Component.options)
  } else {
    hotAPI.reload("data-v-0f69e25b", Component.options)
  }
