...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  render: function render(h) {
    ...
    var hasCtrl = !this.notCtrl && (this.hasResetBtn || this.hasSubmitBtn);
    ...
    }, [this.$slots.prepend, this.renderFormList(h), hasCtrl && this.renderSubmit(h), this.$slots.default]);
  },
  ...
  methods: {
    ...
    renderSubmit: function renderSubmit(h) {
      ...
      if (this.hasSubmitBtn) {
        var submitBtn = h(getPrefix('button', this.lib), {
          props: {
            type: 'primary'
          },
          on: {
      ...
      if (this.hasResetBtn) {
        ...
        var resetBtn = h(getPrefix('button', this.lib), {
          style: style,
          on: {
            click: this.submit
          }
